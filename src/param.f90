module mod_param
...
#ifdef TWOD
  integer, parameter :: itot = 2, jtot = 256, ktot = 256
#else
  ...
  real(8), parameter :: sc  = 3.87d0          ! schmidt number for gas phase
  real(8), parameter :: ste = 1.34d0          ! eva! scaled by gas temperature
                                              !Hexadecane*0.9+heptane*0.1
  real(8), parameter :: lambda_rho0 = 52.0d0  !((700*0.9+585*0.1))/13.23 !kg/m3
  real(8), parameter :: lambda_mu0  = 27.0d0  !((6.6859e-04+1.7096e-04)/2)/2.2958e-05!pa/s
  real(8), parameter :: lambda_cp0  = 2.83d0  !((2.5294e+03+5.8690e3)/2)/1.0086e+03!j/(kg.k)
  real(8), parameter :: lambda_ka0  = 3.55d0  !((0.1198+0.0938)/2)/0.0330!
  real(8), parameter :: lambda_mm1  = 7.80d0  !226!g/mol
  real(8), parameter :: lambda_mm2  = 3.46d0  !100.21!g/mol
  real(8), parameter :: lambda_mav  = 5.63d0  !g/mol
  ...
  real(8), parameter :: tc1 = 723, pc1 = 1.4e+6
  real(8), parameter :: tc2 = 540, pc2 = 2.73e+6
  real(8), parameter :: ru = 8314.d0
  real(8), parameter :: m2 = 28.9647d0!g/mol
  real(8), parameter :: res    = 12.d0
  real(8), parameter :: lref   = 0.25d0*lz !res*dx
  real(8), parameter :: nu2    =  1.735e-6
  real(8), parameter :: d_m12    = 4.8157e-7!nu2/sc
  real(8), parameter :: d_m12_2  = 8.2547e-7!nu2/sc
  real(8), parameter :: uref   = d_m12/lref!re*k0_wave*nu2
  real(8), parameter :: u_abc  = uref
  real(8), parameter :: pth_0  = 15*101325!phi_p3*pc
  real(8), parameter :: tmp0   = 400!phi_p4*tc
  real(8), parameter :: rho2_0 = pth_0/(phi_p2*(ru/m2)*tmp0)!13.23!kg/m3
  ...
  !boiling point at 1 atm around 525K
  ...
  integer, parameter :: iout1d    = 1*20 ! print 
  integer, parameter :: iout2d    = 1*20
  !integer, parameter :: iout3d    = 5000*40
  integer, parameter :: iout3d    =  2000
  ...
  real(8), parameter :: cp2       = 1.0086e+03!ru/(phi_p1*m2)
  real(8), parameter :: mu2       = 2.2958e-05!nu2*rho2_0
  ...
  real(8), parameter :: diff_coef_1_12m = 6.5e-07  !!!corresponds to schmidt number (nu_liq/diff_liq)equal to 1 
#endif
  !
