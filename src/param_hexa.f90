module mod_param
  ...
  real(8), parameter :: lambda_rho0 = 22.0d0  !((700+686)/2)/13.23
  real(8), parameter :: lambda_mu0  = 26.0d0  !((6.6859e-04+5.1687e-04)/2)/2.2958e-05
  real(8), parameter :: lambda_cp0  = 2.51d0  !2.5339e+03/1.0086e+03
  real(8), parameter :: lambda_ka0  = 3.56d0  !((0.1198+0.1157)/2)/0.0330
  ...
  real(8), parameter :: tc2 = 693, pc2 = 1.57e+6
  ...
  real(8), parameter :: nu2    =  2.318e-6
  real(8), parameter :: d_m12    = 4.8e-7!nu2/sc
  real(8), parameter :: d_m12_2  = 5.9e-7!nu2/sc
  ...
  real(8), parameter :: rho2_0 = pth_0/(phi_p2*(ru/m2)*tmp0)!13.23
  ...
  real(8), parameter :: lheat     = 3.1e+05!cp2*tmp0/ste ! be sure to put a good Ste
  ...
  real(8), parameter :: diff_coef_1_12m = 8.5e-07  
#endif
  !
